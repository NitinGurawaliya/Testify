          ...
          <div className=" flex flex-col items-center">
            <div className="text-center">
             <Subheading label={"Login to  your account "}/>
              ...
              <Heading label={"Hey enter your details to access your account"} />
            </div>
            <div className="w-full flex-1 mt-8">
              <div className="mx-auto max-w-xs flex flex-col gap-4">
               ...
               <AuthButton onClick={userHandler} label={"Signin As a Student"} />

               <AuthButton onClick={adminHandler} label={"Signin As a Admin"} />
               
               <BottomWarning label={"Already have an account "} to={"/signup"} buttonText={"Signin"} />
              </div>
            </div>
          </div>
        </div>
